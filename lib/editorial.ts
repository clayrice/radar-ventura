...
O Radar precisa formar uma edição diária com pelo menos três histórias. Seja seletivo nas primeiras escolhas e flexível com matérias sólidas que tenham interesse humano ou utilidade empresarial, mesmo quando o impacto não for extraordinário. Reserve a rejeição para textos insuficientes, repetitivos, excessivamente técnicos, sem perspectiva verificável ou sem relação plausível com trabalho e negócios.
